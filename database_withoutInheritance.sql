...
CREATE TABLE "group_lesson" (
 ...
 "maximum_no_of_students" VARCHAR(5) NOT NULL,
 "minimum_no_of_students" VARCHAR(5) NOT NULL,
...
ALTER TABLE "group_lesson" ADD CONSTRAINT FK_group_lesson_1 FOREIGN KEY ("student_id") REFERENCES "student" ("student_id");
ALTER TABLE "group_lesson" ADD CONSTRAINT FK_group_lesson_2 FOREIGN KEY ("schedule_id") REFERENCES "schedule" ("schedule_id");
...
ALTER TABLE "group_lesson" ADD CONSTRAINT FK_group_lesson_4 FOREIGN KEY ("pricing_id") REFERENCES "pricing" ("pricing_id");

ALTER TABLE "ensemble" ADD CONSTRAINT FK_ensemble_0 FOREIGN KEY ("instructor_id") REFERENCES "instructor" ("instructor_id");
ALTER TABLE "ensemble" ADD CONSTRAINT FK_ensemble_1 FOREIGN KEY ("student_id") REFERENCES "student" ("student_id");
ALTER TABLE "ensemble" ADD CONSTRAINT FK_ensemble_2 FOREIGN KEY ("schedule_id") REFERENCES "schedule" ("schedule_id");
ALTER TABLE "ensemble" ADD CONSTRAINT FK_ensemble_3 FOREIGN KEY ("skill_level_id") REFERENCES "skill_level" ("skill_level_id");
ALTER TABLE "ensemble" ADD CONSTRAINT FK_ensemble_4 FOREIGN KEY ("pricing_id") REFERENCES "pricing" ("pricing_id");
...
ALTER TABLE "individual_lesson" ADD CONSTRAINT FK_individual_lesson_2 FOREIGN KEY ("schedule_id") REFERENCES "schedule" ("schedule_id");
...
ALTER TABLE "individual_lesson" ADD CONSTRAINT FK_individual_lesson_4 FOREIGN KEY ("pricing_id") REFERENCES "pricing" ("pricing_id");
